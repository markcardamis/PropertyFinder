...
const SavedFiltersListItem = ({ onSelect, onChangeFrequency, onEdit, onDelete, data }: SavedFiltersListItemProps) => {
    ...
    return (
        <div className='savedFilters-filterItem' onClick={onSelect}>
          <div className='savedFilters-filterHeader' style={{ display: "flex" }}>
            <div onClick={onSelect} className='savedFilters-filterTitle'>{data.title ? data.title : "Untitled"}</div>
            <div className='savedFilterEdit'>
                <div onClick={onChangeFrequency} className='savedFilterEdit-icon'>{notificationIcon}</div>
                <div onClick={onEdit} className='savedFilterEdit-icon'><IconPencil/></div>
