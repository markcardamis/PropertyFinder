        ...
        try {
            if (filename != null && primaryKeyColumn != null && propertyKey != null && propertyFieldColumn != null) {
                ...
                while (scanner.hasNext()) {
                    ...
                    if (primaryKeyColumn <= line.size() && propertyFieldColumn <= line.size()) {
                        for (int i = 0; i < line.size(); i++) {
                            //System.out.print("CSV Column " + i + " " + line.get(i));
                            if (line.get(primaryKeyColumn).equals(propertyKey)) {
                                return line.get(propertyFieldColumn);
                            }
                        }
                    }
                }
